...
export const Navbar = () => {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-white/5 bg-black/30 backdrop-blur-[3px]">
      <nav className="flex h-[92px] w-full items-center">
        <Link to="/" className="flex h-full shrink-0 items-start justify-start">
          <img
            src="/NAVBAR/logo.svg"
            alt="Ceballos Artículos Religiosos"
            className="block h-[70px] w-auto object-contain object-left-top sm:h-[78px] lg:h-[92px]"
          />
        </Link>
        ...
        <div className="hidden shrink-0 justify-end pr-[4.2%] lg:flex">
          <a
        ...
        <button
          ...
          className="ml-auto mr-6 flex items-center justify-center text-white lg:hidden"
        >
